 ...
 * basenames, and home expansion, used by guard.ts and bash.ts.
 */
...
/** The spec makes ignore files read-only for agents. Both spellings of the
 *  global file are protected. */
export const PROTECTED_BASENAMES = new Set([".agentignore", ".agentsignore"]);
